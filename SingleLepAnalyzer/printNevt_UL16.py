...
parser.add_argument("-i", "--inputdir", default="/isilon/hadoop/store/user/fsimpson/FWLJMET106XUL_singleLep2016UL_RunIISummer20v2_step1hadds/nominal", help="The path to the step1hadds directory (background samples)")
parser.add_argument("-s", "--sigdir", default="/isilon/hadoop/store/group/bruxljm/FWLJMET106XUL_singleLep2016UL_RunIISummer20v2_PUupdated_step1hadds/nominal", help="The path to the step1hadds directory (signal samples)")
