...
inputDir='/isilon/hadoop/users/jluo48/CHiggs/UL17/XGB_CSV_REDNEW/SR1'#'/eos/uscms/store/user/lpcbril/MC_test/FWLJMET106X_1lep2017_UL_step2_CSV_SR1_added'
outputDir= '/isilon/hadoop/users/jluo48/CHiggs/UL17/XGB_models_REDNEW/SR1' 
condorDir= runDir+'/condor_logs_CSVtoXGB_SR1_REDNEW/'
