...
bst300 = xgb.Booster()
bst300.load_model("XGB700iterations_3depths_0.05signal_region_NewVar_test_M300.model")
...
newtree.Branch("XGB300_RS", XGB300_RS, "XGB300_RS/D")
...
for chunk in sig_tree.iterate("*", entrysteps=10000, namedecode="utf-8"):
    ...
    #ichunk+=1
    chunck_size = len(XGB300pred)
    for k in range(chunck_size):
        if iev%100000==0:
            print(iev)
        XGB300[0] = XGB300pred[k]
        XGB300_RS[0] = Reshape(XGB300[0]) 
