...
parser.add_argument("-l", "--varListKey", default="NewVar_nc", help="Input variable list")
...
bst200 = xgb.Booster()
bst200.load_model("XGB_M200_SRAll.json")

bst220 = xgb.Booster()
bst220.load_model("XGB_M220_SRAll.json")

bst250 = xgb.Booster()
bst250.load_model("XGB_M250_SRAll.json")

bst300 = xgb.Booster()
bst300.load_model("XGB_M300_SRAll.json")

bst350 = xgb.Booster()
bst350.load_model("XGB_M350_SRAll.json")

bst400 = xgb.Booster()
bst400.load_model("XGB_M400_SRAll.json")

bst500 = xgb.Booster()
bst500.load_model("XGB_M500_SRAll.json")

bst600 = xgb.Booster()
bst600.load_model("XGB_M600_SRAll.json")

bst700 = xgb.Booster()
bst700.load_model("XGB_M700_SRAll.json")

bst800 = xgb.Booster()
bst800.load_model("XGB_M800_SRAll.json")

bst1000 = xgb.Booster()
bst1000.load_model("XGB_M1000_SRAll.json")

bst1250 = xgb.Booster()
bst1250.load_model("XGB_M1250_SRAll.json")

bst1500 = xgb.Booster()
bst1500.load_model("XGB_M1500_SRAll.json")

bst1750 = xgb.Booster()
bst1750.load_model("XGB_M1750_SRAll.json")

bst2000 = xgb.Booster()
bst2000.load_model("XGB_M2000_SRAll.json")

bst2500 = xgb.Booster()
bst2500.load_model("XGB_M2500_SRAll.json")

bst3000 = xgb.Booster()
bst3000.load_model("XGB_M3000_SRAll.json")

bst200_SR1 = xgb.Booster()
bst200_SR1.load_model("XGB_M200_SR1.json")

bst220_SR1 = xgb.Booster()
bst220_SR1.load_model("XGB_M220_SR1.json")

bst250_SR1 = xgb.Booster()
bst250_SR1.load_model("XGB_M250_SR1.json")

bst300_SR1 = xgb.Booster()
bst300_SR1.load_model("XGB_M300_SR1.json")

bst350_SR1 = xgb.Booster()
bst350_SR1.load_model("XGB_M350_SR1.json")

bst400_SR1 = xgb.Booster()
bst400_SR1.load_model("XGB_M400_SR1.json")

bst500_SR1 = xgb.Booster()
bst500_SR1.load_model("XGB_M500_SR1.json")

bst600_SR1 = xgb.Booster()
bst600_SR1.load_model("XGB_M600_SR1.json")

bst700_SR1 = xgb.Booster()
bst700_SR1.load_model("XGB_M700_SR1.json")

bst800_SR1 = xgb.Booster()
bst800_SR1.load_model("XGB_M800_SR1.json")

bst1000_SR1 = xgb.Booster()
bst1000_SR1.load_model("XGB_M1000_SR1.json")

bst1250_SR1 = xgb.Booster()
bst1250_SR1.load_model("XGB_M1250_SR1.json")

bst1500_SR1 = xgb.Booster()
bst1500_SR1.load_model("XGB_M1500_SR1.json")

bst1750_SR1 = xgb.Booster()
bst1750_SR1.load_model("XGB_M1750_SR1.json")

bst2000_SR1 = xgb.Booster()
bst2000_SR1.load_model("XGB_M2000_SR1.json")

bst2500_SR1 = xgb.Booster()
bst2500_SR1.load_model("XGB_M2500_SR1.json")

bst3000_SR1 = xgb.Booster()
bst3000_SR1.load_model("XGB_M3000_SR1.json")

bst200_SR2 = xgb.Booster()
bst200_SR2.load_model("XGB_M200_SR2.json")

bst220_SR2 = xgb.Booster()
bst220_SR2.load_model("XGB_M220_SR2.json")

bst250_SR2 = xgb.Booster()
bst250_SR2.load_model("XGB_M250_SR2.json")

bst300_SR2 = xgb.Booster()
bst300_SR2.load_model("XGB_M300_SR2.json")

bst350_SR2 = xgb.Booster()
bst350_SR2.load_model("XGB_M350_SR2.json")

bst400_SR2 = xgb.Booster()
bst400_SR2.load_model("XGB_M400_SR2.json")

bst500_SR2 = xgb.Booster()
bst500_SR2.load_model("XGB_M500_SR2.json")

bst600_SR2 = xgb.Booster()
bst600_SR2.load_model("XGB_M600_SR2.json")

bst700_SR2 = xgb.Booster()
bst700_SR2.load_model("XGB_M700_SR2.json")

bst800_SR2 = xgb.Booster()
bst800_SR2.load_model("XGB_M800_SR2.json")

bst1000_SR2 = xgb.Booster()
bst1000_SR2.load_model("XGB_M1000_SR2.json")

bst1250_SR2 = xgb.Booster()
bst1250_SR2.load_model("XGB_M1250_SR2.json")

bst1500_SR2 = xgb.Booster()
bst1500_SR2.load_model("XGB_M1500_SR2.json")

bst1750_SR2 = xgb.Booster()
bst1750_SR2.load_model("XGB_M1750_SR2.json")

bst2000_SR2 = xgb.Booster()
bst2000_SR2.load_model("XGB_M2000_SR2.json")

bst2500_SR2 = xgb.Booster()
bst2500_SR2.load_model("XGB_M2500_SR2.json")

bst3000_SR2 = xgb.Booster()
bst3000_SR2.load_model("XGB_M3000_SR2.json")

bst200_SR3 = xgb.Booster()
bst200_SR3.load_model("XGB_M200_SR3.json")

bst220_SR3 = xgb.Booster()
bst220_SR3.load_model("XGB_M220_SR3.json")

bst250_SR3 = xgb.Booster()
bst250_SR3.load_model("XGB_M250_SR3.json")

bst300_SR3 = xgb.Booster()
bst300_SR3.load_model("XGB_M300_SR3.json")

bst350_SR3 = xgb.Booster()
bst350_SR3.load_model("XGB_M350_SR3.json")

bst400_SR3 = xgb.Booster()
bst400_SR3.load_model("XGB_M400_SR3.json")

bst500_SR3 = xgb.Booster()
bst500_SR3.load_model("XGB_M500_SR3.json")

bst600_SR3 = xgb.Booster()
bst600_SR3.load_model("XGB_M600_SR3.json")

bst700_SR3 = xgb.Booster()
bst700_SR3.load_model("XGB_M700_SR3.json")

bst800_SR3 = xgb.Booster()
bst800_SR3.load_model("XGB_M800_SR3.json")

bst1000_SR3 = xgb.Booster()
bst1000_SR3.load_model("XGB_M1000_SR3.json")

bst1250_SR3 = xgb.Booster()
bst1250_SR3.load_model("XGB_M1250_SR3.json")

bst1500_SR3 = xgb.Booster()
bst1500_SR3.load_model("XGB_M1500_SR3.json")

bst1750_SR3 = xgb.Booster()
bst1750_SR3.load_model("XGB_M1750_SR3.json")

bst2000_SR3 = xgb.Booster()
bst2000_SR3.load_model("XGB_M2000_SR3.json")

bst2500_SR3 = xgb.Booster()
bst2500_SR3.load_model("XGB_M2500_SR3.json")

bst3000_SR3 = xgb.Booster()
bst3000_SR3.load_model("XGB_M3000_SR3.json")
