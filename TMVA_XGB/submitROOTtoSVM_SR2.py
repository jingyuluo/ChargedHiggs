...
outputDir= '/eos/uscms/store/user/lpcbril/MC_test/FWLJMET106X_1lep2017_UL_step2_SVM_SR2_splited/'
condorDir= runDir+'/condor_logs_SVM_SR2/'
...
for mass in Masses:
    ...
    jdf.write(
"""universe = vanilla
Executable = %(RUNDIR)s/submitROOTtoSVM_SR2.sh
Request_memory = 8000
Should_Transfer_Files = YES
WhenToTransferOutput = ON_EXIT
Transfer_Input_Files = %(RUNDIR)s/UpROOTtoSVM_SR2.py, %(RUNDIR)s/varsList.py 
Output = M%(MASS)s.out
Error = M%(MASS)s.err
Log = M%(MASS)s.log
Notification = Never
