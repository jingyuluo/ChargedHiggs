...
inputDir='/isilon/hadoop/store/user/fsimpson/FWLJMET106XUL_singleLep2016APVUL_RunIISummer20v2_step2/'+shift+'/' #'/isilon/hadoop/store/user/dali/FWLJMET106XUL_singleLep2016APVUL_RunIISummer20_3t_step2/'+shift+'/'
...
#    if 'TTTo' in file: continue
    ...
    jdf.write(
"""universe = vanilla
Executable = ../submitApplication_SRs.sh
Request_memory = 8000
Should_Transfer_Files = IF_NEEDED
WhenToTransferOutput = ON_EXIT
Transfer_Input_Files = ../XGBApply_SRs.py, ../varsList.py 
