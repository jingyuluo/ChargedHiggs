...
outputDir= '/isilon/hadoop/users/jluo48/CHiggs/UL17/XGB_CSV/SR2'#'/eos/uscms/store/user/lpcbril/MC_test/FWLJMET106X_1lep2017_UL_step2_CSV_SR2_added/'
...
for mass in Masses:
    ...
    jdf.write(
"""universe = vanilla
Executable = %(RUNDIR)s/submitROOTtoCSV_SR2.sh
Request_memory = 8000
