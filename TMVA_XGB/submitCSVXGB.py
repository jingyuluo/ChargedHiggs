...
inputDir='/isilon/hadoop/users/jluo48/CHiggs/UL17/XGB_CSV_REDNEW/SRAll'#'/eos/uscms/store/user/lpcbril/MC_test/FWLJMET106X_1lep2017_UL_step2_CSV_SRAll_added'
outputDir= '/isilon/hadoop/users/jluo48/CHiggs/UL17/XGB_models_REDNEW/SRAll' 
condorDir= runDir+'/condor_logs_CSVtoXGB_SRAll_REDNEW/'
