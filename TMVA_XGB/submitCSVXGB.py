...
inputDir='/eos/uscms/store/user/lpcbril/MC_test/FWLJMET106X_1lep2017_UL_step2_CSV_SR3_added'
outputDir= '/eos/uscms/store/user/lpcbril/MC_test/FWLJMET106X_1lep2017_UL_step2_CSV_SR3_models_added'
condorDir= runDir+'/condor_logs_CSVtoXGB_SR3_added_new/'
...
#    if 'TTTo' in file: continue
    dict={'RUNDIR':runDir, 'CONDORDIR':condorDir, 'INPUTDIR':eosindir, 'MASS':mass, 'OUTPUTDIR':eosoutdir}
