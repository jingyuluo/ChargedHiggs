...
inputDir='/isilon/hadoop/store/user/fsimpson/FWLJMET106XUL_singleLep2018UL_RunIISummer20v2_step2/'+shift+'/' #'/isilon/hadoop/store/user/dali/FWLJMET106XUL_singleLep2017UL_RunIISummer20_3t_step2/'+shift+'/'
