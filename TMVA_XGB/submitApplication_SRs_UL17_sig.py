...
inputDir='/isilon/hadoop/store/group/bruxljm/jingyu/FWLJMET106XUL_singleLep2017UL_RunIISummer20v2PUupdated__step2/'+shift+'/' #'/isilon/hadoop/store/user/fsimpson/FWLJMET106XUL_singleLep2017UL_RunIISummer20v2_step2/'+shift+'/' #'/isilon/hadoop/store/user/dali/FWLJMET106XUL_singleLep2017UL_RunIISummer20_3t_step2/'+shift+'/'
outputDir= '/isilon/hadoop/store/group/bruxljm/jluo48/CHiggs_XGB/XGB_test_new/UL17/'+shift+'/' # or 2017APV
condorDir= runDir+'/condor_logs_XGBSRs_UL17_NEWNEWTEST_'+shift+'/'
