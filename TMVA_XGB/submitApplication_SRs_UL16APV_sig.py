...
inputDir='/isilon/hadoop/store/group/bruxljm/jingyu/FWLJMET106XUL_singleLep2016APVUL_RunIISummer20v2PUupdated__step2/'+shift+'/' #'/isilon/hadoop/store/user/fsimpson/FWLJMET106XUL_singleLep2016APVUL_RunIISummer20v2_step2/'+shift+'/' #'/isilon/hadoop/store/user/dali/FWLJMET106XUL_singleLep2016APVUL_RunIISummer20_3t_step2/'+shift+'/'
outputDir= '/isilon/hadoop/store/group/bruxljm/jluo48/CHiggs_XGB/XGB_test_new/UL16APV/'+shift+'/' # or 2016APVAPV
condorDir= runDir+'/condor_logs_XGBSRs_UL16APV_NEWNEWTEST_'+shift+'/'
...
#BDTlist = ['BDT']
#varListKeys = ['NewVar']#['2016APVAPVAN']
