...
inputDir='/isilon/hadoop/store/group/bruxljm/FWLJMET106XUL_singleLep2016UL_RunIISummer20_3t_step2/'+shift+'/'
outputDir= '/isilon/hadoop/store/group/bruxljm/jluo48/CHiggs_XGB/XGB_reduced/UL16/'+shift+'/' # or 2017
condorDir= runDir+'/condor_logs_XGBSRs_signal_UL16_reduced_'+shift+'/'
